    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-16">
          ...
          <h2 className="text-xl font-semibold mb-2">Prescriptions Module</h2>
          <p className="text-muted-foreground text-center max-w-md mb-4">
            This module will include prescription creation, medication database,
            dosage templates, and prescription history.
          </p>
